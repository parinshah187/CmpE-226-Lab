...
<head>
	<meta charset="utf-8">
	<title> CMPE-226 Database Systems </title>
	<style type="text/css">
/*!
 * Bootstrap v2.3.2
 *
...
.affix {
	...
	<body>
	<img src="http://www.dbservices.it/wp-content/uploads/2013/05/db2.jpg" class="span2"> <a href="#"></a> </img>
		<div class="container">
			<h1> <a href="/CmpE-226-Lab/rest/users/products"> CMPE-226 Database Systems </a> </h1>
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container">
						<ul class="nav">
						<li class="active span2"><a href="#"> CMPE226.com </li>
						<li class="span6"><input type="text" id="searchbar"
							class="form-control span6" placeholder="Search"></li>
						<li class="span1">
							<button type="submit" class="add-on" onclick="search()">
								<img
									src="http://www.clker.com/cliparts/Q/l/L/B/F/a/search-icon-md.png"
									width="20">
							</button>
						</li>
					</ul>
		...
		<div>
			<ul class="nav nav-list span3">
				...
				<li> <a href="/CmpE-226-Lab/rest/users/electronics"> Electronics </a></li>
				<li> <a href="/CmpE-226-Lab/rest/users/homeappliances"> Home Appliances </a> </li>
				<li> <a href="/CmpE-226-Lab/rest/users/fashion"> Fashion </a> </li>
				<li> <a href="/CmpE-226-Lab/rest/users/books"> Books </a> </li>
	...
	<tr>
		<#list items as item>
			<td width="300" align="center">
				<a href="/CmpE-226-Lab/rest/users/product/${item.product_id}"> <img src=${item.URL} height="100" width="100"> </a> <br /> 
				<a href="/CmpE-226-Lab/rest/users/product/${item.product_id}"> ${item.name} </a> <br /> 
				Price :  ${item.price} <br /> 
			</td>
		</#list>
	</tr>
...
<!-- Footer starts here -->
	...
	function search(){
		...
		if(a!=""){
			window.location="http://localhost:8080/CmpE-226-Lab/rest/users/query/"+a;
		}
	}
	</script>	
	</body>
